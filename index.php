              ...
              <section class="trainer-section spad">
                 <div class="container">
                     ...
                     <div class="trainer-slider">
                         <div class="trainer-item"></div>
                         <div class="ts-item">
                             <div >
                                 <div class="trainer-item">
                                     <div class="ti-img"></div>
                                     <div class="ti-text"></div>
                                     <div class="ti-social"><a><h6>f</h6></a></div>
                                 </div>
                             </div>
                             <div id="ts-item_2" class="ts-item"></div>
                             <div id="ts-item_3" class="ts-item"></div>
                             <div id="ts-item_4" class="ts-item"></div>
                             <div id="ts-item_5" class="ts-item"></div>
                             <div id="ts-item_6" class="ts-item"></div>
                         </div>
                     </div>
                 </div>    
               </section>
